...
type User struct {
	...
	MicrositeRejectedCount int64     `json:"microsite_rejected_count" gorm:"-"`
	MicrositeApprovedCount int64     `json:"microsite_approved_count" gorm:"-"`
	MicrositePendingCount  int64     `json:"microsite_pending_count" gorm:"-"`
	TimeStamp
}
